        ...
        profileContainer.innerHTML = `
            <div class="header" style="text-align: left; padding: 0;">
                ...
                <div class="welcome-video-container" style="border-color: var(--color-cta); overflow: hidden; border-radius: 12px; position: relative; background-color: #1a1a1a; height: 350px;">
                    <img src="assets/dashboard_banner_hd.png" alt="Welcome to Chased" class="welcome-video" id="profile-welcome-video" style="width: 100%; height: 100%; object-fit: cover; display: block; margin: 0; padding: 0;">
